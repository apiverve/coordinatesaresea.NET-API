...
namespace APIVerve
{
    public class CoordinatesAreSeaAPIClient
    {
        ...
        public CoordinatesAreSeaAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public CoordinatesAreSeaAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(coordinatesareseaQueryOptions options)
        {
            try
            {
                if (_isDebug)
